...
import com.example.nyesteventure3.travelguide.Subactivity.Notify1;
...
ArrayList<LatLng> MarkerPoints;
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        btnPark.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                GetNearbyPlacesData getNearbyPlacesData = new GetNearbyPlacesData();
                getNearbyPlacesData.execute(DataTransfer);
                Toast.makeText(MapsActivity.this,"Nearby Park", Toast.LENGTH_LONG).show();
            }
        });
        ...
        mMap.setOnMapClickListener(new GoogleMap.OnMapClickListener() {
            ...
            public void onMapClick(LatLng point) {
                ...
                // Adding news_data item to the ArrayList
                ...
                // Add news_data marker to the Google Map Android API V2
    ...
    private  void addnotification()
    {
        ...
        ed.putBoolean("val",flag);
        ed.commit();

        NotificationCompat.Builder builder=
                (NotificationCompat.Builder) new NotificationCompat.Builder(this)
                        .setSmallIcon(R.drawable.logooriginal)
                        .setContentTitle("You Have a Notification")
                        .setContentText("Destination reached");

        Intent notificationIntent=new Intent(this,Notify1.class);
    ...
    private String getUrl(double latitude, double longitude, String nearbyPlace) {
     ...
     googlePlacesUrl.append("&radius=" + PROXIMITY_RADIUS);
      ...
      googlePlacesUrl.append("&key=" + "AIzaSyBiaoXm9DCM3cFdatnwSeeBMBp1K8DvaME");
