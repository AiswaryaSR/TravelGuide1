...
public class Fare_delhi extends Fragment {

//    AutoCompleteTextView txt_to,txt_from;
//    String[] to={"Noida","Janakpuri","Ajmeri Gate","Bhopura","Faridabad"};
//    String[] from={"Dwaraka","Azadpur","Budh Nagar","Delhi Gate","Fatehpuri"};
   ...
   EditText editText1,editText2;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        getActivity().setTitle("Fare Delhi");
