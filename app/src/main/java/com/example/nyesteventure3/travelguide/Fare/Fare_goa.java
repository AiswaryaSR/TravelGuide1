...
public class Fare_goa extends Fragment {


//    AutoCompleteTextView txt_to,txt_from;
//    String[] to={"Morpirla","Margao","Dongor","Rivona","Barcem"};
//    String[] from={"Shiroda","Dudal","Curdi","Palolem","Colva"};
...
//                        auto.setText("Value is not available");
//                        car.setText("Value is not available");
//                        bus.setText("Value is not available");
//                        dist.setText("Value is not available");
//                        time.setText("Value is not available");
