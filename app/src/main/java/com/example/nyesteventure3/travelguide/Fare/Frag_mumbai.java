...
public class Frag_mumbai extends Fragment {


//    AutoCompleteTextView txt_to,txt_from;
//    String[] to={"Kurla","Trombay","Borivali","Muthkur","Hoodi"};
//    String[] from={"Juhu","Gorai","Chembur East","Cave Temple","Kothnur"};
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        getActivity().setTitle("Fare Mumbai");
