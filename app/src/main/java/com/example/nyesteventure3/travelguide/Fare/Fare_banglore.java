...
public class Fare_banglore extends Fragment {

//    AutoCompleteTextView txt_to,txt_from;
//    String[] to={"Koramangala","Jayanagar","Huskur","Muthkur","Hoodi","kochi"};
//    String[] from={"Channenahalli","Ullal","Omkara Hills","Cave Temple","Kothnur","kochi"};
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        getActivity().setTitle("Fare Banglore");
